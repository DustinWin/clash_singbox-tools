...
2. 若想自己生成配置文件 user.yaml，可以 [Fork 本项目](https://github.com/DustinWin/Clash-Files/fork)后编辑[.github/workflows/auto-task.yml](https://github.com/DustinWin/Clash-Files/blob/main/.github/workflows/auto-task.yml) 和 [MyConfig](https://github.com/DustinWin/Clash-Files/tree/main/MyConfig) 目录下的.yaml 文件
