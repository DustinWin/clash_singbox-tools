...
0 4 * * 1,3,5 curl -o /tmp/Yacd-meta.tar.gz -L https://github.com/DustinWin/clash-tools/raw/main/Yacd-meta/Yacd-meta.tar.gz && tar -zxf /tmp/Yacd-meta.tar.gz -C $clashdir/ui --overwrite && rm -f /tmp/Yacd-meta.tar.gz && /data/clash/start.sh restart >/dev/null 2>&1 #每周一、三、五早上 4 点更新 Yacd-meta 面板
